...
echo curl -i http://localhost:8080/scaninspectimage?tarfile=/opt/blackduck/hub-imageinspector-ws/target/alpine.tar
echo curl -i http://localhost:8080/scaninspectimage?tarfile=/opt/blackduck/hub-imageinspector-ws/target/fedora.tar
echo curl -i http://localhost:8080/scaninspectimage?tarfile=/opt/blackduck/hub-imageinspector-ws/target/debian.tar
